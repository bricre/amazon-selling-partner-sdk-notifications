# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Notifications
...
```shell
composer require bricre/amazon-selling-partner-sdk-notifications
```
...
```php
<?php
use Amz\Notifications\ResponseTypes;
